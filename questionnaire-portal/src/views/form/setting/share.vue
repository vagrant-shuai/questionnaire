<template>
  <div class="project-setting-view">
    ...
    <div
      v-if="
        shareSettingForm.shareWxDesc ||
        shareSettingForm.shareWxTitle ||
        shareSettingForm.shareWxImg
      "
    >
  ...
  methods: {
    ...
    saveSettingHandle() {
      this.$refs["shareSettingForm"].validate((valid) => {
        // 图片检查
        if (
          this.shareSettingForm.shareWxImg &&
          !this.shareSettingForm.shareWxImgUrl
        ) {
